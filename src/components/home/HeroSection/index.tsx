...
export function HeroSection() {
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden pt-16">
      <div className="absolute inset-0 pointer-events-none bg-[linear-gradient(to_right,rgba(6,10,18,0.92)_0%,rgba(6,10,18,0.75)_49%,rgba(6,10,18,0)_90%)] lg:bg-[linear-gradient(to_right,rgba(6,10,18,0.92)_0%,rgba(6,10,18,0.75)_38%,rgba(6,10,18,0)_68%)]" />
